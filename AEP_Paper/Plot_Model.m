...
% this models dipoles for figure 3
% three figures:
%   - right contralateral (base model)
%   - left contralateral
%   - left contralateral reduced (i.e. changing only those params compared
%       to right that really matter)
